...
$('#btnBuscar').click(function() {  // EVENTO DEL BOTON BUSCAR
	search($('#txtBuscar').val());
	return false;
});

$('#txtBuscar').keypress(function(e){  // EVENTO AL ESCRIBIR EN EL TEXTBOX BUSCAR
		search($(this).val());
});
