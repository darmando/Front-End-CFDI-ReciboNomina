...
<body>
  <?php
 // mysql_connect("127.0.0.1:3306","root","") or die ("No se pudo conectar a la Base de datos");
     // ob_start();
  ...
  <div class="row">
	<div class="panel panel-info">
	  ...
	  <div class="panel-body">
	      <div class="row">
	      	  <div class="col-md-12">
	      	     <label for="txtRFCEmisor">Busqueda del cliente:</label>
	      ...
	      <div class="row">
 	      	  <div class="col-md-6">
    		        <label class="checkbox">
			            <input type="checkbox" id="chkEmisonInfoCliente"> Ver información del cliente        
			        </label>
			  </div>
	      </div>
